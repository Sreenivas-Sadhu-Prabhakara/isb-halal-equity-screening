package com.bank.islamic.halalequityscreening.model;
...
/**
 * The BIAN control record for this service domain: "Equity Screening Result Assessment".
 *
 ...
 * to its asset type (Equity Screening Result). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Equity Screening Result Assessment";
